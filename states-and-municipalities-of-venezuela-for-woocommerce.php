...
if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) {
	...
	function smvw_woocommerce_required() {
		...
		// translators: 1-4. Strong tags
		$message = wp_sprintf(__('%1$sStates and Municipalities of Venezuela for WooCommerce%2$s plugin requires %1$sWooCommerce%2$s activated. The plugin was deactivated until you active %1$sWooCommerce%2$s', 'states-and-municipalities-of-venezuela-for-woocommerce'), '<strong>', '</strong>');
		echo '
